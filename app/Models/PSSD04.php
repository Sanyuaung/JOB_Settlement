...
class PSSD04 extends Model
{
    ...
    public static function data(Request $req)
    {
        ...
        if ($validation) {
            ...
            DT_04_CARD.CURRENCY_CODE, DT_04_CARD.Source, DT_04_TXN.No_of_transactions,
            round((DT_04_TXN.Transaction_Amount/C.MarketRate),2) as Transaction_Amount, 
            round(DT_04_TXN.Transaction_Amount,2) as Txn_Amt_MMK,C.MarketRate as Remark
            from
            (select AUTHTXN_REQUEST_DATE,Card_Name, Category_of_Card, Category_of_Transaction, CURRENCY_CODE, Source,count(*) as No_of_Used_Card  from 
            (select AUTHTXN_REQUEST_DATE, A.AUTHTXN_CARD_NO,

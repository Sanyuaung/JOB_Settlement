...
class inc01c extends Model
{
    ...
    public static function inc01c()
    {
        ...
        B.MERCHANT_ID AS Card_Acceptor_Identification,B.MERCHANT_TRADE_NAME as Card_Acceptor_Name,
        ...
        substring(Field1,276,5) as Reserved from inc01cs A inner join merchants B WHERE substring(Field1,139,15) = B.MERCHANT_ID');
        return $inc01c;
    }
}

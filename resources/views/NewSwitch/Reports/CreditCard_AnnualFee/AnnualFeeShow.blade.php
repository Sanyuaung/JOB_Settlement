...
@section('content')
    ...
    <div class="container-fluid">
        <div class="scroll-table-container">
            ...
            <div class="btn4">
                <a href="{{ route('AnnualFeedownload', ['month1' => $month1, 'date2' => $date2, 'date1' => $date1]) }}" onclick="return confirm('Are you sure you want to download?')"
                    role="button"><span>Download EXCEL</span></a>
            </div>
            <div><label class="float-right mr-3">Report Date : {{ $date1 }}</label></div>
            <br><br><br>
            {{-- <div class="scroll-table-container"> --}}

...
@section('content')
    ...
    <div class="container">
        <div class="h">
            <h1 id="VISA" class="grey-text text-center">Welcome CBM Reports (PSSD_01)</h1>
        ...
        <div class="card-body px-lg-5 pt-0 datepicker ">
            ...
            <!-- Form -->
            <form class="text-center" action="{{ route('pssd01print') }}" method="post">
                @csrf
                ...
                {{-- <div class="md-form mt-4">
                    ...
                    <label for="materialRegisterFormEmail">End Date&nbsp;<span class="iconify" data-icon="flat-color-icons:calendar" data-width="25"></span></label>
                    @error('end')
                        <p class="text-danger">{{ $message }}</p>
                    @enderror
                </div> --}}

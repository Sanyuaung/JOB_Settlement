...
<link href="/css/style.css" rel="stylesheet">
   ...
   {{-- <label class="font-weight-bold text-danger"><b>{{$filename}}</label> --}}
       <div class="text-center">
        ...
        <div>
          <a href="{{route('downloadICOM')}}" onclick="return confirm('Are you sure you want to download?')" class="btn white-text btn-indigo btn-rounded-pill" role="button">Download EXCEL</a>

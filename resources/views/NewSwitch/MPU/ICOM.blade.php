...
@section('content')
   ...
   <label class="font-weight-bold text-danger"><b>{{$filename}}</label>
       <div class="text-center">
        ...
        <div>
                <a href="{{route('downloadICOM')}}" onclick="return confirm('Are you sure you want to download?')" class="mt-2 ml-4 btn btn-primary float-left rounded-pill" role="button">Download EXCEL</a>
        </div>
            <br>
            <br>
